...
{{-- @foreach ($content as $edit)
    <div class="modal fade" id="exampleModal{{ $edit->getMakeup->id }}" tabindex="-1" role="dialog"
                ...
                <form action="{{ url('/booking') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $edit->getMakeup->description }}" class="form-control"
                                readonly>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Harga</label>
                            <input type="hidden" name="price" value="{{ $edit->getMakeup->price }}"
                                class="form-control">
                            <input type="text" value="Rp.{{ number_format($edit->getMakeup->price, 0, ',', '.') }}"
